...
body {
    background: url('assets/images/bghome.jpg') no-repeat 0px 0px;
    background-size: cover;
    font-family: 'Open Sans', sans-serif;
    background-attachment: fixed;
    background-position: center;
    /* background: rgb(31,164,232);
	background: linear-gradient(90deg, rgba(31,164,232,1) 0%, rgba(0,212,255,1) 100%); */
}
...
.main-agileinfo {
    ...
    width: 50%;
    background: rgba(127, 200, 255, 0.73);
    border-radius: 16px;
...
form {
    /* background:rgba(3, 3, 3, 0.57); isuri2 */
    padding: 25px;
}
...
<div class="main-agileinfo">
    ...
    <h1 class="text-danger brand mt-2">
    ...
    <div class="sap_tabs">
        <div id="horizontalTab">
            ...
            <div class="resp-tabs-container">
                <div class="tab-1 resp-tab-content roundtrip">
                    <form action="book_flight.php" method="post" class="flight-form">
                        <input type="hidden" name="type" value="round">
                        <div class="form-group from">
                            <h3 class="text-light">From</h3>
                            <?php
        ...
        echo '<select class="custom-select" name="dep_city" id="dep_city">
        ...
        mysqli_stmt_execute($stmt);          
        $result = mysqli_stmt_get_result($stmt);    
        echo '<select class="custom-select" name="arr_city" id="arr_city">
        ...
        ?>
                        ...
                        <div class="date">
                            <div class="depart">
                                <h3>Depart</h3>
                                <input class="form-control" name="dep_date" type="date" required>
                            </div>
                            <div class="return">
                                <h3>Return</h3>
                                <input class="form-control" name="ret_date" type="date" required>
                            </div>
                            <div class="clear"></div>
                        </div>
                        <div class="class">
                            <h3>Class</h3>
                            <select name="f_class" class="custom-select">
                        ...
                        <div class="clear"></div>
                        <input type="submit" value="Search Flights" name="search_but" class="btn btn-primary">
                    </form>
...
<div id="about" class="conatiner-fluid p-4" style="margin-top:150px;">
...
<footer class="mt-5">
    <em>
        <h5 class="text-light text-center p-0 brand mt-2">
            ...
            ABC Flight Booking World..!
        </h5>
    </em>
    <div class="text-light text-center">&copy; <?php echo date('Y')?> - Developed By @isu&#x1F493;<br><br></div>
    <!-- <p>----------</p> -->
