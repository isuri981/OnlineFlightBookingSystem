            ...
            if (!mysqli_stmt_prepare($stmt, $sql)) {
                ...
                if ($row = mysqli_fetch_assoc($result)) {
                    ...
                    if (!mysqli_stmt_prepare($stmt, $sql)) {
                        ...
                        $sqlp = "SELECT * FROM `passenger_profile` ORDER BY `passenger_id` DESC LIMIT 1";
                        ...
                        if ($resultp->num_rows > 0) {
                            ...
                            while ($rowp = $resultp->fetch_assoc()) {
                                $pid = $rowp['passenger_id'];
                            }

                            // Output or manipulate the stored data as needed
                            // print_r($column_data);
                        } else {
                ...
                if (!mysqli_stmt_prepare($stmt, $sql)) {
                    ...
                    if ($row = mysqli_fetch_assoc($result)) {
                        ...
                        if (!mysqli_stmt_prepare($stmt, $sql)) {
                            ...
                            $sqlSP = "CALL ApplyDiscount()";

                            if ($conn->query($sqlSP) === TRUE) {
