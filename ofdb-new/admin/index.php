...
.dashbord-red .detail-section{
    ...
    <main><!-- log on to codeastro.com for more projects -->
        <?php if(isset($_SESSION['adminId'])) { ?>
          <div class="container">
            ...
            <div class="main-section">
              ...
              <div class="dashbord dashbord-green" style="background-color: #ffffff;">
                <div class="icon-section">
      ...
      <div class="card-body">
        ...
        <p class="">Today's Flights</p>
        <table class="table-sm table table-hover">
          <thead class="" style="background-color: rgba(41, 27, 255, 0.78);">
    ...
    <div class="card" id="issue">
      <div class="card-body">
        ...
        <p class="">Today's Flight Issues</p>
        <table class="table-sm table table-hover">
        <thead class="" style="background-color: rgba(41, 27, 255, 0.78);">
            <tr><!-- log on to codeastro.com for more projects -->
              <th scope="col">#</th>
    ...
    <div class="card" id="dep">
      <div class="card-body">
        ...
        <p class="">Flights Departed Today</p>
        <table class="table-sm table table-hover">
        <thead class="" style="background-color: rgba(41, 27, 255, 0.78);">
            <tr><!-- log on to codeastro.com for more projects -->
              <th scope="col">#</th>
    ...
    <div class="card mb-4" id="arr">
      <div class="card-body">
        ...
        <p class="">Flights Arrived Today</p>
        <table class="table-sm table table-hover">
        <thead class="" style="background-color: rgba(41, 27, 255, 0.78);">
            <tr><!-- log on to codeastro.com for more projects -->
              <th scope="col">#</th>
