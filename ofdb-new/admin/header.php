...
<html lang="en">
    <head>
        ...
        <title>ABC Flight Booking World..!</title>          
        <link rel = "icon" href =  
...
button.btn-outline-light:hover {
  ...
  h4 {
    ...
    <body>
        ...
        <nav class="navbar navbar-custom navbar-expand-lg bg-primary">
          ...
          <?php
              if(isset($_SESSION['adminId'])) { ?>
                ...
                <li class="nav-item">
                  ...
                  <li class="nav-item">
                    <a class="nav-link text-light" href="flight.php">
                      <h5 class="ml-2"> Add Flight</h5>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link text-light" href="all_flights.php">
                      <h5>List Flights</h5>
                    </a>
                  </li>   
                  <li class="nav-item">
                    <a class="nav-link text-light" href="list_airlines.php">
