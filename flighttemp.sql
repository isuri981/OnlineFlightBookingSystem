...
--
-- Host: 127.0.0.1
-- Generation Time: May 04, 2024 at 09:00 AM
...
(150, 'passenger_profile', 'insert', 10, '2024-05-04 03:50:56'),
(151, 'payment', 'insert', 27, '2024-05-04 03:51:14'),
(152, 'flight', 'update', 27, '2024-05-04 03:51:14'),
(153, 'flight', 'update', 27, '2024-05-04 03:51:14'),
(154, 'passenger_profile', 'insert', 11, '2024-05-04 04:05:48'),
(155, 'payment', 'insert', 35, '2024-05-04 04:06:06'),
(156, 'flight', 'update', 35, '2024-05-04 04:06:06'),
(157, 'flight', 'update', 35, '2024-05-04 04:06:06'),
(158, 'passenger_profile', 'delete', 9, '2024-05-04 04:10:11'),
(159, 'passenger_profile', 'update', 11, '2024-05-04 06:09:01'),
(160, 'flight', 'insert', 38, '2024-05-04 06:11:35'),
(161, 'flight', 'insert', 39, '2024-05-04 06:12:38'),
(162, 'flight', 'update', 38, '2024-05-04 06:14:35'),
(163, 'flight', 'update', 39, '2024-05-04 06:16:52');
...
(27, 1, '2024-04-19 20:02:00', '2024-04-19 18:02:00', 'Oriaridge', 'Chiby', 'Echo Airline', '193', '4', 66, '', '', '25C', 20, ''),
...
(35, 1, '2024-04-27 00:05:00', '2024-04-26 21:00:00', 'Oriaridge', 'Chicago', 'Nep Airways', '202', '84', 1545, '', '', '23A', 20, ''),
...
(38, 1, '2024-05-04 17:32:00', '2024-05-04 15:40:00', 'Zhotrora', 'Trerdence', 'Spark Airways', '125', '45', 3200, 'issue', '', '', 20, ''),
(39, 1, '2024-05-04 17:06:00', '2024-05-04 16:41:00', 'Otiginia', 'Oyladnard', 'Novar Airways', '158', '12', 6500, 'dep', '', '', 20, '');
...
(10, 1, 27, '772887612', '2000-02-07 00:00:00', 'isuri', 'j', 'samaranayake'),
(11, 9, 35, '712226071', '2000-02-07 00:00:00', 'Erangi', 'e', 'disanayake');
...
--
-- Stand-in structure for view `passenger_profile_view`
-- (See below for the actual view)
--
CREATE TABLE `passenger_profile_view` (
`passenger_id` int(11)
...
(71, 8, 27, 12, '24E', 127, 'E'),
(72, 8, 27, 12, '24F', 127, 'E'),
(73, 8, 27, 12, '25A', 127, 'E'),
(78, 8, 27, 12, '24E', 127, 'E'),
(79, 8, 27, 12, '24F', 127, 'E'),
(80, 8, 27, 12, '25A', 127, 'E'),
(83, 10, 27, 1, '25B', 132, 'E'),
(84, 10, 27, 1, '25C', 132, 'E'),
(85, 11, 35, 9, '22F', 3090, 'E'),
(86, 11, 35, 9, '23A', 3090, 'E');
...
(9, 'Erangi', 'erangi@mail.com', '202cb962ac59075b964b07152d234b70'),
...
--
-- Structure for view `passenger_profile_view`
--
DROP TABLE IF EXISTS `passenger_profile_view`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `passenger_profile_view`  AS SELECT `pp`.`passenger_id` AS `passenger_id`, `u`.`email` AS `user_email`, `f`.`airline` AS `flight_airline`, `pp`.`mobile` AS `mobile`, `pp`.`dob` AS `dob`, `pp`.`f_name` AS `f_name`, `pp`.`m_name` AS `m_name`, `pp`.`l_name` AS `l_name` FROM ((`passenger_profile` `pp` join `users` `u` on(`pp`.`user_id` = `u`.`user_id`)) join `flight` `f` on(`pp`.`flight_id` = `f`.`flight_id`)) ;
